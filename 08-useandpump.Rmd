...
Electricity consumption in EGAT substations decreased from 84 GWh in 2010 to 64 GWh in 2015. It is assumed that the electricity consumption will be similar to those in 2019 (see Figure \@ref(fig:plot-useegatsub)).
...
## Electricity use in pumped storage hydropower plants
The data is extracted from `01 EGAT_20Oct2022_งบ66 67_Final.xlsx`. The R code chuck is given below.
...
TOTUSEPUMP_{t} = ELY_{headoffice,t}+ELY_{substation,t}+ELY_{stationserv,t}+ELY_{maemoh,t}+ELY_{pump,t}
(\#eq:totalUsePump)
...
$ELY_{headoffice}$ denotes an electricity consumption in EGAT head office and others in year $t$.\
$ELY_{substation}$ denotes an electricity consumption in EGAT substations in year $t$.\
$ELY_{stationserv,t}$ denotes an electricity consumption in EGAT station services in year $t$.\
$ELY_{maemoh,t}$ denotes an electricity consumption in EGAT Mae Moh mining in year $t$.\
$ELY_{pump,t}$ denotes an electricity consumption in EGAT pumped storage hydropower plants in year $t$.\
