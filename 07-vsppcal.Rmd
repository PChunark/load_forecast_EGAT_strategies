...
```{r plot-comparecontractvsppPDP2018r1-PDP2022c7, echo=FALSE, warning=FALSE, message=FALSE, fig.cap='Contract capacity from VSPPs', fig.align='center', out.width= '90%'}
cbind(
  vsppcontractcapPDP2018R1 %>%
  ...
  geom_text_repel(data = annopdp2018r12030cont,
            ...
            label = paste0(formatC(contract_mw, format = "d", big.mark = ",")," GWh")
            ),
            hjust = 0.9,
            size = 4,
            nudge_y = 2000,
  ...
  geom_text_repel(data = annopdp2022c72037cont,
            ...
            inherit.aes = FALSE)
```
```{r plot-comparecontractfuelvsppPDP2018r1-PDP2022c7, echo=FALSE, warning=FALSE, message=FALSE, fig.cap='Contract capacity mix from VSPPs ', fig.align='center', out.width= '90%'}
full_join(
  vsppcontractcapPDP2018R1 %>%
    filter(year >= "2022") %>% 
  select(year,fuel, vspp_pdp2018rev1 = contract_mw),
