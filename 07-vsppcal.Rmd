...
```{r plot-merge_vspp_ext_pdp, echo=FALSE, warning=FALSE, message=FALSE, fig.cap='Total electricity generation from VSPPs in PDP2018 Rev.1', fig.align='center', out.width= '90%'}
merge_vspp_ext_pdp %>% 
