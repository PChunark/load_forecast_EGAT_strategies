...
vsppcontractcapPDP2018R1 %>%
  mutate(fuel = factor(fuel, c("coal", "diesel", "gas", "biogas", "biomass", "iew", "msw", "hydro (small)", "solar", "wind", "ee", "total"))) %>%
...
Total VSPPs contract capacity in the PDP2018 Rev.1 is higher than those in the PDP2022 case 7 by 33.9% in 2037 (see Figure \@ref(fig:plot-comparecontractvsppPDP2018r1-PDP2022c7)). Electricity generation from VSPPs shows a similar trend (see Figure \@ref(fig:plot-comparevsppPDP2018r1-PDP2022c7)).
...
```
```{r plot-comparecontractvsppPDP2018r1-PDP2022c7, echo=FALSE, fig.align='center', fig.cap='VSPPs contract capacity', message=FALSE, warning=FALSE, out.width='90%'}
cbind(
  vsppcontractcapPDP2018R1 %>%
