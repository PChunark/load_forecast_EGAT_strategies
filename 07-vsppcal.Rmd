...
Total VSPPs contract capacity in the PDP2018 Rev.1 is higher than those in the PDP2022 case 7 by 33.9% in 2037. 
...
```
```{r plot-comparecontractvsppPDP2018r1-PDP2022c7, echo=FALSE, fig.align='center', fig.cap='VSPPs contract capacity', message=FALSE, warning=FALSE, out.width=}
cbind(
  vsppcontractcapPDP2018R1 %>%
