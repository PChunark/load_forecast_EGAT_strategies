...
outfigdir <- c("figures/")
```
## The EGAT electrity sale profile to MEA
The electricity sale profile from EGAT to MEA is given by the Power System Control and Operation Division (ฝ่ายควบคุมระบบกำลังไฟฟ้า).
```{r, MEA EGAT sale}
...
Calculate the peak, minimun in the unit of MW, and electricity sale to MEA in GWh from the profile.
