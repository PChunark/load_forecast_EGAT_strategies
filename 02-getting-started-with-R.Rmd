...
install.packages("tidyverse", "readxl","scales", "glue","knitr", "plotly")
```
...
* A `plotly` [package](https://plotly.com/r/getting-started/) is an alternative package to a `ggplot2` package. It is an interactive web-base graphic [@ployly2023]. 
