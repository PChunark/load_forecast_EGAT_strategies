...
```{r plot-totmeavspppdp2018rev1, echo=FALSE, warning=FALSE, message=FALSE, fig.cap='Total electricity generation from MEA's VSPP in the PDP2018 revision 1', fig.align='center', out.width= '90%'}
tot_mea_vspp_pdp2018rev1 %>% 
  ggplot(aes(x = year,
             y = tot_mea_gwh))+
  geom_line(aes(group = fuel, color = fuel),
