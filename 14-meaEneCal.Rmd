...
The MEA electricity requirement increases from 53,290 GWh in 2022 to 71,127 GWh in 2037. It increases `r round((((71127/53290)^(1/(2037-2022)))-1)*100,3)`% annually (see Figure \@ref(fig:plot-newmeaene)). 
  ...
  labs(x = NULL,
    ...
    geom_text_repel(data = annonewmeaene2019,
                  aes(x = year, y = mea_gwh,
                      label = paste0(formatC(mea_gwh, format = "d", big.mark = ","), " GWh")),
                  hjust = 0.5,
                  size = 3.5,
                  nudge_x = 1,
                  nudge_y = 10000,
...
An electricity generation from existing VSPP in the MEA areas is from cogeneration power plants, hydropower, solar power, waste power plants. Total generation would reach its peak 235 GWh in 2017. It would remain 193 GWh from 2019-2037 (see Figure \@ref(fig:plot-meavspppdp2018r1)).
...
An electricity generation from newly VSPP in the MEA areas is from biogas, biomass hydropower, solar power for community, waste power plants and energy efficiency improvement. Total generation would be almost 10,000 GWh in 2037 (see Figure \@ref(fig:plot-meanewvspppdp2018r1)).

```{r plot-meanewvspppdp2018r1, echo=FALSE, warning=FALSE, message=FALSE, fig.cap='Projected electricity generation from newly VSPP contracts in the PDP2018 revision 1', fig.align='center', out.width= '90%'}
mea_newvspp_pdp2018r1 %>% 
  filter(!fuel %in% c("biomass_community", "ind_waste", "wind")) %>% 
  ggplot(aes(x = year, 
             y = mea_gwh))+
  geom_line(aes(group = fuel, color = fuel),
            show.legend = FALSE)+
...
```{r annototmeavspppdp2018r1, echo=FALSE, warning=FALSE, message=FALSE}
annototmeavspppdp2018r12015 <-
  tot_mea_vspp_pdp2018rev1 %>% 
  filter(year == 2015)

annototmeavspppdp2018r12020 <-
  tot_mea_vspp_pdp2018rev1 %>% 
  filter(year == 2020)

annototmeavspppdp2018r12030 <-
  tot_mea_vspp_pdp2018rev1 %>% 
  filter(year == 2030)

annototmeavspppdp2018r12037 <-
  tot_mea_vspp_pdp2018rev1 %>% 
  filter(year == 2037)
```

The PDP2018 rev.1 estimated that total electricity generation from VSPP in the MEA area will increase from 54 GWh in 2015 to 10,227 GWh in 2037. Solar power for community will dominate the generation.
```{r plot-totmeavspppdp2018rev1, echo=FALSE, warning=FALSE, message=FALSE, fig.cap='Total MEA electricity generation from VSPP in the PDP2018 revision 1', fig.align='center', out.width= '90%'}
tot_mea_vspp_pdp2018rev1 %>% 
  ggplot(aes(x = year,
             y = tot_mea_gwh))+
  geom_line(aes(group = fuel, color = fuel),
  ...
  geom_text_repel(data = annototmeavspppdp2018r12015,
                  aes(x = year, y = tot_mea_gwh,
                      label = paste0(formatC(tot_mea_gwh, format = "d", big.mark = ","), " GWh")),
                  hjust = 0.5,
                  size = 3.2,
                  nudge_x = 1,
                  nudge_y = 1000,
                  inherit.aes = FALSE)+
  geom_text_repel(data = annototmeavspppdp2018r12020,
                  aes(x = year, y = tot_mea_gwh,
                      label = paste0(formatC(tot_mea_gwh, format = "d", big.mark = ","), " GWh")),
                  hjust = 0.5,
                  size = 3.2,
                  ...
                  nudge_y = 1000,
                  inherit.aes = FALSE)+
  geom_text_repel(data = annototmeavspppdp2018r12030,
                  aes(x = year, y = tot_mea_gwh,
                      label = paste0(formatC(tot_mea_gwh, format = "d", big.mark = ","), " GWh")),
                  hjust = 0.5,
                  size = 3.2,
                  ...
                  nudge_y = 1000,
                  inherit.aes = FALSE)+
  geom_text_repel(data = annototmeavspppdp2018r12037,
                  aes(x = year, y = tot_mea_gwh,
                      label = paste0(formatC(tot_mea_gwh, format = "d", big.mark = ","), " GWh")),
                  hjust = 0.5,
                  size = 3.2,
...
```{r annoegtslemeapdp2018r1, echo=FALSE, warning=FALSE, message=FALSE}
annoegtslemeapdp2018r12019 <-
  egt_sle_mea_pdp2018r1 %>% 
  filter(year == 2019) %>% 
  select(sector,year,egatsale)

annoegtslemeapdp2018r12030 <-
  egt_sle_mea_pdp2018r1 %>% 
  filter(year == 2030) %>% 
  select(sector,year,egatsale)

annoegtslemeapdp2018r12037 <-
  egt_sle_mea_pdp2018r1 %>% 
  filter(year == 2037) %>% 
  select(sector,year,egatsale)
```

```{r annomeareqpdp2018r1, echo=FALSE, warning=FALSE, message=FALSE}
annomeareqpdp2018r12019 <-
  egt_sle_mea_pdp2018r1 %>% 
  filter(year == 2019) %>% 
  select(sector,year,mea_gwh)

annomeareqpdp2018r12030 <-
  egt_sle_mea_pdp2018r1 %>% 
  filter(year == 2030) %>% 
  select(sector,year,mea_gwh)

annomeareqpdp2018r12037 <-
  egt_sle_mea_pdp2018r1 %>% 
  filter(year == 2037) %>% 
  select(sector,year,mea_gwh)
```
...
```{r plot-egtsleMeaPdp2018r1, echo=FALSE, warning=FALSE, warning=FALSE, fig.cap='MEA electricity requirement and EGAT electricity sale to MEA in the PDP2018 revision 1', fig.align='center', out.width= '90%'}
egt_sle_mea_pdp2018r1 %>%
  pivot_longer(-c(sector,year,year_th), names_to = "category", values_to = "ene_gwh") %>%
  filter(category != "tot_mea_gwh") %>%
  ggplot(aes(x = year, y = ene_gwh, group = category, color=category))+
  ...
  scale_color_manual(name = NULL,
                     values = linepalette1,
                     labels = c("EGAT sale to MEA", "MEA requirement"))+
  ThemeLine+
  ...
  scale_y_continuous(breaks = seq(0,80000,10000),
                     limits = c(0,80000),
                     labels = comma)+
  geom_text_repel(data = annoegtslemeapdp2018r12019,
                  aes(x = year, y = egatsale,
                      label = paste0(formatC(egatsale, format = "d", big.mark = ","), " GWh")),
                  hjust = 0.5,
                  size = 3.2,
                  nudge_x = 1,
                  nudge_y = -10000,
                  inherit.aes = FALSE)+
  geom_text_repel(data = annoegtslemeapdp2018r12030,
                  aes(x = year, y = egatsale,
                      label = paste0(formatC(egatsale, format = "d", big.mark = ","), " GWh")),
                  hjust = 0.5,
                  size = 3.2,
                  ...
                  nudge_y = -10000,
                  inherit.aes = FALSE)+
  geom_text_repel(data = annoegtslemeapdp2018r12037,
                  aes(x = year, y = egatsale,
                      label = paste0(formatC(egatsale, format = "d", big.mark = ","), " GWh")),
                  hjust = 0.5,
                  size = 3.2,
                  ...
                  nudge_y = -10000,
                  inherit.aes = FALSE)+
  geom_text_repel(data = annomeareqpdp2018r12019,
                  aes(x = year, y = mea_gwh,
                      label = paste0(formatC(mea_gwh, format = "d", big.mark = ","), " GWh")),
                  hjust = 0.5,
                  size = 3.2,
                  ...
                  nudge_y = 7000,
                  inherit.aes = FALSE)+
  geom_text_repel(data = annomeareqpdp2018r12030,
                  aes(x = year, y = mea_gwh,
                      label = paste0(formatC(mea_gwh, format = "d", big.mark = ","), " GWh")),
                  hjust = 0.5,
                  size = 3.2,
                  ...
                  nudge_y = 10000,
                  inherit.aes = FALSE)+
  geom_text_repel(data = annomeareqpdp2018r12037,
                  aes(x = year, y = mea_gwh,
                      label = paste0(formatC(mea_gwh, format = "d", big.mark = ","), " GWh")),
                  hjust = 0.5,
                  size = 3.2,
...
## VSPP in MEA in the PDP2023 case7
...
read_excel("raw_data/Case7_VSPP+DEDE+NVSPP_เพิ่มภาค.xlsx",
  ...
  rename_all(tolower) %>% 
  pivot_longer(-year, names_to = "fuel", values_to = "tot_mea_gwh") %>%
  filter(fuel %in% c("gas", "msw", "solar","total")) %>%
  ggplot(aes(x = year, y = tot_mea_gwh))+
  geom_line(aes(group = fuel, color = fuel),
            show.legend = FALSE)+
  facet_wrap(~fuel,
             scales = "free_y")+
