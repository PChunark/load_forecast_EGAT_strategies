...
## Electricity generation from VSPP in the MEA
...
## Electricity generation from VSPP in the PEA
...
## Electricity generation from DEDE in the PEA

Total electricity generation from DEDE substantially increased from `r round(pea_dede_ene %>% filter(year == 2005) %>% select(pea_dede_gwh) %>% pull(),0)` GWh in 2005 and reach its peak 
...
```{r, plot-totvspp-ene-2005-2021, echo=FALSE, warning=FALSE, message=FALSE, fig.cap='Electricity generation from VSPP during 2015–2021.', fig.align='center', out.width= '90%'}
tot_vspp_ext %>% 
